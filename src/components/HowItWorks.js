...
export default function HowItWorks() {
  ...
  return (
    <div className="p-20">
      <h2 className="text-5xl font-semibold">Start Optimizing With Only <span className="text-amber-600">4 Steps</span></h2>
      ...
      <div className="flex mt-8 w-full text-center">
        ...
        <div className={`p-6 w-1/4 hover:cursor-pointer flex items-center ${currentStep == 1 ? activeBorder : inActiveBorder}`} onClick={() => setCurrentStep(1)}>
          ...
          &nbsp;&nbsp;
          <h3>Get a Full SEO Audit Report</h3>
        </div>
        <div className={`p-6 w-1/4 hover:cursor-pointer flex items-center ${currentStep == 2 ? activeBorder : inActiveBorder}`} onClick={() => setCurrentStep(2)}>
          ...
          &nbsp;&nbsp;
          <h3>Optimize with AI Suggestions</h3>
        </div>
        <div className={`p-6 w-1/4 hover:cursor-pointer flex items-center ${currentStep == 3 ? activeBorder : inActiveBorder}`} onClick={() => setCurrentStep(3)}>
          ...
          &nbsp;&nbsp;
          <h3>Track & Improve Rankings</h3>
        </div>
      </div>

      {currentStep == 0 ? (
        <div className="border-1 border-zinc-800 rounded-2xl p-16 grid grid-cols-2 items-center">
          <div className="leading-8 ">
            <h2 className="text-5xl font-medium"> Submit your website to start the SEO analysis.</h2>
      ...
      {currentStep == 1 ? (
        <div className="border-1 border-zinc-800 rounded-2xl p-16 grid grid-cols-2 items-center">
          <div className="leading-8 ">
            <h2 className="text-5xl font-medium"> See detailed insights on speed, backlinks, keywords & more.</h2>
      ...
      {currentStep == 2 ? (
        <div className="border-1 border-zinc-800 rounded-2xl p-16 grid grid-cols-2 items-center">
          <div className="leading-8 ">
            <h2 className="text-5xl font-medium"> Get actionable steps to fix errors & boost rankings.</h2>
      ...
      {currentStep == 3 ? (
        <div className="border-1 border-zinc-800 rounded-2xl p-16 grid grid-cols-2 items-center">
          <div className="leading-8 ">
            <h2 className="text-5xl font-medium"> Monitor progress with real-time SEO reports.</h2>
